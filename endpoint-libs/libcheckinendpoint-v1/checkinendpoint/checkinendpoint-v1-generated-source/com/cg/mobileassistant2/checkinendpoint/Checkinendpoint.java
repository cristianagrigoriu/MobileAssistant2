 ...
 * on 2014-05-05 at 14:39:10 UTC 
 * Modify at your own risk.
 */

package com.cg.mobileassistant2.checkinendpoint;
...
public class Checkinendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetCheckIn extends CheckinendpointRequest<com.cg.mobileassistant2.checkinendpoint.model.CheckIn> {
    ...
    protected GetCheckIn(java.lang.Long id) {
      super(Checkinendpoint.this, "GET", REST_PATH, null, com.cg.mobileassistant2.checkinendpoint.model.CheckIn.class);
   ...
   * operation.
   *
   * @param content the {@link com.cg.mobileassistant2.checkinendpoint.model.CheckIn}
   * @return the request
   */
  public InsertCheckIn insertCheckIn(com.cg.mobileassistant2.checkinendpoint.model.CheckIn content) throws java.io.IOException {
    InsertCheckIn result = new InsertCheckIn(content);
    initialize(result);
    return result;
  }

  public class InsertCheckIn extends CheckinendpointRequest<com.cg.mobileassistant2.checkinendpoint.model.CheckIn> {
     ...
     * @since 1.13
     */
    protected InsertCheckIn(com.cg.mobileassistant2.checkinendpoint.model.CheckIn content) {
      super(Checkinendpoint.this, "POST", REST_PATH, content, com.cg.mobileassistant2.checkinendpoint.model.CheckIn.class);
    }
  ...
  public class ListCheckIn extends CheckinendpointRequest<com.cg.mobileassistant2.checkinendpoint.model.CollectionResponseCheckIn> {
    ...
    protected ListCheckIn() {
      super(Checkinendpoint.this, "GET", REST_PATH, null, com.cg.mobileassistant2.checkinendpoint.model.CollectionResponseCheckIn.class);
    }
   ...
   * @return the request
   */
  public UpdateCheckIn updateCheckIn(com.cg.mobileassistant2.checkinendpoint.model.CheckIn content) throws java.io.IOException {
    UpdateCheckIn result = new UpdateCheckIn(content);
    initialize(result);
    return result;
  }

  public class UpdateCheckIn extends CheckinendpointRequest<com.cg.mobileassistant2.checkinendpoint.model.CheckIn> {
     ...
     * @since 1.13
     */
    protected UpdateCheckIn(com.cg.mobileassistant2.checkinendpoint.model.CheckIn content) {
      super(Checkinendpoint.this, "PUT", REST_PATH, content, com.cg.mobileassistant2.checkinendpoint.model.CheckIn.class);
    }
